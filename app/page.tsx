      ...
      <section className="bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 py-16 md:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="text-3xl sm:text-6xl md:text-7xl font-bold leading-none text-gray-900 dark:text-white">Zapas</span>
            <span className="text-3xl sm:text-6xl md:text-7xl font-bold leading-none text-blue-600 dark:text-blue-400">YA Reseñas</span>
          </div>
