...
async function main() {
  const reviews = [
    ...
    { id: '16', tipo: 'seller', targetId: 's5', targetName: 'Urban Kicks', userId: 'user_3DK1NXhCR69ixMT496ab2Z4j0cd', userName: 'Usuario Prueba', rating: 4, comentario: 'Buena atención al cliente, respondieron rápido mis consultas.', estado: 'published' },
    ...
    { id: '19', tipo: 'seller', targetId: 's6', targetName: 'Sneakers Store', userId: 'user_3DK1NXhCR69ixMT496ab2Z4j0cd', userName: 'Usuario Prueba', rating: 5, comentario: 'Excelente servicio, el envío llegó antes de lo previsto.', estado: 'published' },
